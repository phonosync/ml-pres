...
%%| fig-align: center
flowchart TD
    A["Artificial Intelligence"] --> |"Simulate Human Intelligence in Reasoning, Learning, Perception"| H1((" "))
    H1 --> B["Symbolic AI"]
    H1 --> C["Sub-symbolic AI"]

    B --> |"Information is represented in human-readable form"| D["Rule based/Expert systems"]

    C --> |"Pattern recognition from data"| E["Machine Learning"]

    E --> |"Neural Networks with multiple layers"| F["Deep Learning"]

    G["Big Data<br>structured & unstructured"]  --> C

    style H1 fill:transparent,stroke:transparent,color:transparent
```
...
- Specific applications of each paradigm
